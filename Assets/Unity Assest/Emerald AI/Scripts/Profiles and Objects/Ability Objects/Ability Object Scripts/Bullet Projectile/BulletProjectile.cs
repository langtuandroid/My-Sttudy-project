...
namespace EmeraldAI
{
    ...
    public class BulletProjectile : MonoBehaviour, IAvoidable
    {
        ...
        void InitializeProjectile ()
        {
            ...
            if (Physics.Raycast(transform.position, transform.TransformDirection(Vector3.forward), out hit, 60, ~CurrentAbilityData.BulletProjectileSettings.IgnoreLayers))
            {
