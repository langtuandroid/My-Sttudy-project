...
namespace EmeraldAI
{
    ...
    public class AbilityData
    {
        ...
        {
            [HideInInspector] public bool Enabled = true;
            [Tooltip("The layers that bullets will ignore. This is useful for bypassing collisions with certain object or colliders that you don't want interfering with the bullets.")] //added 1.0.5.1
